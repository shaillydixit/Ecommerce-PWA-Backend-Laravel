...
class ProductListController extends Controller
{
    ...
    $save_url3 = 'upload/productdetails/'.$name_gen3;
    ...
    $save_url4 = 'upload/productdetails/'.$name_gen4;
