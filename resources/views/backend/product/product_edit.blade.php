                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="mb-3">
                                        <img id="showImage" src="{{ asset($product->image_one )   }}"
                                            style="width:100px; height: 100px;">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <img id="showImage" src="{{ asset($product->image_two )   }}"
                                            style="width:100px; height: 100px;">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <img id="showImage" src="{{ asset($product->image_three )   }}"
                                            style="width:100px; height: 100px;">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <img id="showImage" src="{{ asset($product->image_four )   }}"
                                            style="width:100px; height: 100px;">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description" class="form-control"
                                            id="inputProductDescription" rows="3">{!! $product->short_description !!}</textarea>
                                    </div>
